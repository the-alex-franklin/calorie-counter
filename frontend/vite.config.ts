	...
	plugins: [
		...
		uno({
			...
			theme: {
				colors: {
					// iOS color palette
					primary: "##1C1C1E", // iOS blue
					secondary: "#34C759", // iOS green
					warning: "#FF9500", // iOS orange
					danger: "#FF3B30", // iOS red
					info: "#5AC8FA", // iOS light blue
					success: "#34C759", // iOS green
					appBlue: "#007AFF", // iOS dark mode background
			...
			shortcuts: {
				...
				"ios-btn-secondary":
					"ios-btn bg-secondaryBg dark:bg-secondaryBgDark text-primary border border-border dark:border-borderDark hover:bg-gray-100 dark:hover:bg-primary/80",
				...
				// Special elements
				"ios-sheet":
					"fixed bottom-0 left-0 right-0 bg-secondaryBg dark:bg-secondaryBgDark rounded-t-ios-lg shadow-lg p-6 transition-all duration-300",
				"ios-navbar":
					"sticky top-0 bg-secondaryBg dark:bg-secondaryBgDark backdrop-blur-md bg-opacity-70 dark:bg-opacity-70 border-b border-border dark:border-borderDark px-4 py-3 flex items-center justify-between",
				"ios-tab-bar":
					"fixed bottom-0 left-0 right-0 bg-secondaryBg dark:bg-secondaryBgDark backdrop-blur-md bg-opacity-70 dark:bg-opacity-70 border-t border-border dark:border-borderDark px-6 py-4 flex items-center justify-around",
				"ios-input":
					"bg-secondaryBg dark:bg-secondaryBgDark border border-border dark:border-borderDark rounded-ios px-4 py-3 focus:outline-none focus:ring-2 focus:ring-primary",
			},
		}),
	],
	define: {
